...
eval( ' function xoops_module_install_'.$mydirname.'( $module ) { return none_oninstall_base( $module , "'.$mydirname.'" ) ; } ' ) ;


if( ! function_exists( 'none_oninstall_base' ) ) {

    function none_oninstall_base( $module , $mydirname )
    {
        ...
        if( defined( 'XOOPS_CUBE_LEGACY' ) ) {
            ...
            $root->mDelegateManager->add( 'Legacy.Admin.Event.ModuleInstall.' . ucfirst($mydirname) . '.Success' , 'none_message_append_oninstall' ) ;
            $ret = array() ;
        } else {
    ...
    function none_message_append_oninstall( &$module_obj , &$log )
    {
